...
const pushDataWithDefaultAlert = data => R.when(R.propSatisfies(R.isNil, 'alert'), R.assoc('alert', getDefaultAlert(data)), data);
...
class APN {
  ...
  sendAPN(regIds, data) {
    const message = new apn.Notification({
      ...
      alert: getPropValueOrUndefinedIfIsSilent('alert', pushDataWithDefaultAlert(data)),
      topic: data.topic,
