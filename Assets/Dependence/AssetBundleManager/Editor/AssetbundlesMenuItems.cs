    ...
    public class AssetBundlesMenuItems
    {
        ...
        private static void BuildBundlesFromSelection()
        {
            ...
            foreach (var o in assets)
            {
                ...
                string packageName = o.name.Substring(o.name.LastIndexOf('_') + 1).ToLower();
                importer.SetAssetBundleNameAndVariant("apps/" + packageName + '/' + o.name.ToLower(), "");
            ...
            BuildScript.BuildAssetBundles(assetBundleBuilds.ToArray(), "selection");
        }
    }
}