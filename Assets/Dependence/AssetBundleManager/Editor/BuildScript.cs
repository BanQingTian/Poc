    ...
    public class BuildScript
    {
        ...
        static public string CreateAssetBundleDirectory(string rootFolder = "")
        {
            ...
            if (string.IsNullOrEmpty(rootFolder))
                ...
                outputPath = Path.Combine(Utility.AssetBundlesOutputPath, Utility.GetPlatformName(), rootFolder);
        ...
        {
            BuildAssetBundles(null, "main");
        }

        public static void BuildAssetBundles(AssetBundleBuild[] builds, string rootFolder)
        {
            // Choose the output path according to the build target.
            string outputPath = CreateAssetBundleDirectory(rootFolder);
