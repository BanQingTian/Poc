                ...
                if (!Async)
                {
                    using (var assetLoader = new AssetLoader())
                    {
                        ...
                        _rootGameObject = assetLoader.LoadFromMemoryWithTextures(fileBytes, extension, assetLoaderOptions, _rootGameObject);
                           ...
                           // filename = "/storage/emulated/0/Bouncing.FBX";
                            Debug.Log("logggg === " + filename);
                            ...
                            else if (!string.IsNullOrEmpty(filename))
                            {
                                ...
                                _rootGameObject = assetLoader.LoadFromFileWithTextures(/*"/storage/emulated/0/Bouncing.FBX"*/filename, assetLoaderOptions);
                            }
                            else
                            {
